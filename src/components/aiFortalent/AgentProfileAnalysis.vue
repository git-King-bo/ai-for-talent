  ...
  founder: {
    ...
    behaviorCards: [
      ...
      },
      {
        label: '团队管理',
        title: '价值观导向',
        desc: '选人优先考量价值观与长期理念一致性，重视团队成员的科研热忱与务实态度，尤其青睐真正对AI for Science感兴趣、愿意做有意义事情的人；管理风格兼具学术严谨性与人文温度，与团队成员保持平等沟通，定期开展深度组会，既注重科研成果的产出，也关注团队成员的成长与心态，营造开放、专注的科研与创业氛围。',
      },
    ],
    preferences: [
      {
  ...
  investor: {
    ...
    behaviorCards: [
      ...
      },
      {
        label: '对创业者的态度',
        title: '耐心陪伴+赋能共生',
        desc: '优先青睐全职投入、具备核心技术与长期信念的创业者，尤其认可AI for Science等前沿领域的科学家创业团队，看重创业者的认知深度、务实态度与坚守初心的品质。依托上海未来产业基金的资源与“未来启点社区”生态，追求与创业者长期共生、共赢，助力创业者将科研理想转化为产业价值，打造源自中国的引领性科技企业。',
      },
      {
        label: '团队管理',
        title: '深度认知培养',
    ...
    preferences: [
      ...
      {
        type: 'positive',
        text: '青睐：具备跨学科视野、有深度认知、务实专业的创业团队，能联动多方资源的科创生态参与者',
      },
      {
        type: 'positive',
